...
//-----------------------factorielle--------------------------
template <unsigned long N> struct Factorielle{
...
//-----------------------puissance--------------------------
template <unsigned long N> struct Puissance{
...
template <unsigned long N> struct Cosinus{
    static double valeur(double x) {
...
//---------------------------sinus--------------------------
template <unsigned long N> struct Sinus{
    static double valeur(double x) {
